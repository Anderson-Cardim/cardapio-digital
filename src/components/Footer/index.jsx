...
export const Footer = () => {
    ...
    return (
        <footer className="bg-[#333] h-60 flex flex-col items-center justify-center gap-8">
            ...
            <a href={whatsappLink} className="flex items-center justify-center p-3 w-[80vw] rounded-2xl bg-green-600 text-[#fff] shadow-md hover:translate-y-[-2px] hover:border-[#005523] cursor-pointer" target="_blank">
